...
portBASE_TYPE xReturn;
	...
	xReturn = xTaskCreate( prvIdleTask, ( signed char * ) "IDLE", (tskIDLE_STACK_SIZE - 64 - 32), ( void * ) NULL, ( tskIDLE_PRIORITY | portPRIVILEGE_BIT ), ( xTaskHandle * ) NULL );
...
#define LED_ON()   GPIO_SetValue(1, 1 << 22)
#define LED_OFF()  GPIO_ClearValue(1, 1 << 22)
/*
 * -----------------------------------------------------------
 * The Idle task.
 * ----------------------------------------------------------
