...
/*tables*/
/*
static uint8_t __ATTR_PROGMEM__ auchCRCHi[] = {
	...
	static char __ATTR_PROGMEM__ auchCRCLo[] = {
...
//	unsigned char uchCRCHi = prevCRC >> 8; //0xFF ; /* high uint8_t of CRC initialized */
//	unsigned char uchCRCLo = prevCRC & 0xFF;//0xFF ; /* low uint8_t of CRC initialized */
//	uint16_t uIndex; /* will index into CRC lookup table */
	while (usDataLen--) /* pass through message buffer */
	{
		prevCRC = AddCRC_RX(*puchMsg++, prevCRC);
		//uIndex = uchCRCLo ^ *puchMsg++ ; /* calculate the CRC */
		//uchCRCLo = uchCRCHi ^ pgm_read_uint8_t(auchCRCHi + uIndex);
		//uchCRCHi = pgm_read_uint8_t(auchCRCLo + uIndex);
	}
