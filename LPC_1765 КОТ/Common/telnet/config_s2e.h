...
typedef struct
{
    ...
    //
    //! Current value of BREAK state
    //
    unsigned char ucBreakState;
...
//
//*****************************************************************************
//#define PORT_PROTOCOL_TELNET    PORT_FLAG_PROTOCOL
//#define PORT_PROTOCOL_RAW       0x00
...
//*****************************************************************************
    ...
    #define DOXYGEN                 1
#else
//    #define CONFIG_RFC2217_ENABLED  0
//    #define DOXYGEN                 0
#endif //_SER2ENET_
