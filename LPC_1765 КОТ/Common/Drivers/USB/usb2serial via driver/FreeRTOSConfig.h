...
#define configCPU_CLOCK_HZ          ( ( unsigned long ) 100000000 )	/* =12Mhz xtal multiplied by 5 using the PLL. */
...
extern uint32_t Get_Stat_tick(void);
#define portCONFIGURE_TIMER_FOR_RUN_TIME_STATS() vConfigureTimerForRunTimeStats()
#define portGET_RUN_TIME_COUNTER_VALUE() Get_Stat_tick()
