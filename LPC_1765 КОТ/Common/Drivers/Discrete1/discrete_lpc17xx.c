...
void PoolDiscrete(DEVICE_HANDLE handle)
{
	...
	#ifdef SMART_SAPSAN
            pInfo->buf[0].d_buf[pInfo->buf[0].in] = 0;
		else 
            pInfo->buf[0].d_buf[pInfo->buf[0].in] = 1;
	#else
		    pInfo->buf[0].d_buf[pInfo->buf[0].in] = 1;
		else 
            pInfo->buf[0].d_buf[pInfo->buf[0].in] = 0;
    ...
    #ifdef SMART_SAPSAN
            pInfo->buf[1].d_buf[pInfo->buf[1].in] = 0;
		else 
            pInfo->buf[1].d_buf[pInfo->buf[1].in] = 1;
	#else
		    pInfo->buf[1].d_buf[pInfo->buf[1].in] = 1;
		else 
            pInfo->buf[1].d_buf[pInfo->buf[1].in] = 0;
	...
	#ifdef SMART_SAPSAN
            pInfo->buf[2].d_buf[pInfo->buf[2].in] = 0;
		else 
            pInfo->buf[2].d_buf[pInfo->buf[2].in] = 1;
	#else
		    pInfo->buf[2].d_buf[pInfo->buf[2].in] = 1;
		else 
            pInfo->buf[2].d_buf[pInfo->buf[2].in] = 0;
	...
	#ifdef SMART_SAPSAN
            pInfo->buf[3].d_buf[pInfo->buf[3].in] = 0;
		else 
            pInfo->buf[3].d_buf[pInfo->buf[3].in] = 1;
	#else
		    pInfo->buf[3].d_buf[pInfo->buf[3].in] = 1;
		else 
            pInfo->buf[3].d_buf[pInfo->buf[3].in] = 0;
