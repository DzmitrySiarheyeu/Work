...
function SendRequest(r_method, r_path, r_args, r_handler, r_tout_handler, r_tout, synchro){
	...
	{
		Request.onreadystatechange = do_response;
...
function GetXMLFile(filename, handler, tout_handler, tout){	
	SendRequest("POST",filename,"",handler, tout_handler, tout, false);
}

function GetXMLFileSynchro(filename, handler, tout_handler, tout){	
	SendRequest("POST",filename,"",handler, tout_handler, tout, true);
}