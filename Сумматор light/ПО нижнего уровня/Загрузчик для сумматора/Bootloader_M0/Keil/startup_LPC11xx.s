...
TABLE_OFFSET       EQU     0x00001000
                PRESERVE8
                THUMB

				EXTERN 	 WAKEUP_IRQHandler
				...
				EXTERN 	 TIMER32_1_IRQHandler
				EXTERN 	 SSP0_IRQHandler
				EXTERN 	 UART_IRQHandler
				EXTERN 	 USB_IRQHandler
				EXTERN 	 USB_FIQHandler
				EXTERN 	 ADC_IRQHandler
				EXTERN 	 WDT_IRQHandler
				EXTERN 	 BOD_IRQHandler
				EXTERN 	 FMC_IRQHandler
				EXTERN 	 PIOINT3_IRQHandler
				EXTERN 	 PIOINT2_IRQHandler
				EXTERN 	 PIOINT1_IRQHandler
				EXTERN 	 PIOINT0_IRQHandler
