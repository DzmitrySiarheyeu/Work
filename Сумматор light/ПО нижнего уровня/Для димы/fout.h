...
#define FOUT_TIMER_CLOCK_DIVIRDER   TIMER2_CLOCK_DIVIRDER_64

//Для кварцевого генератора 8.0 МГц
#define OUT_FRTBL_TO_FR (F_CPU/(64))		// коэффициент используемый для перевода значений из таблицы outFrequency в выходную частоты
