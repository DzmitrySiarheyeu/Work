...
// 0x2213 - Если один из частотных датчиков выдает код диагностики (частота ниже 450Гц) эта частота передается на выход
//			Если нет сигнала от одного из датчиков выдается код 280 - нет 4; 260 - нет 3; 240 - нет 2; 220 - нет 1
