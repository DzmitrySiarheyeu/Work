...
/*tables*/
/*
static byte __ATTR_PROGMEM__ auchCRCHi[] = {
...
static inline unsigned int AddCRC_RX (unsigned char c, unsigned int prevCRC)
{
  unsigned char j;
  unsigned int lsb;
  prevCRC ^= c;
...
unsigned int CRC16 (byte * puchMsg, byte usDataLen, unsigned int prevCRC) /* The function returns the CRC as a unsigned short type */
{
